...
class MonsterSession {
  constructor() {
    ...
    this.updateInterval = 10000; // 200ms 간격 //Todo: 나중에 200ms 수정해야함
    this.socket = null;
  }
  ...
  async update() {
    ...
    if (currentTime - this.lastUpdateTime >= this.updateInterval) {
      ...
      for (const monster of this.monsters.values()) {
        ...
        // 패킷 전송
        const transformInfo = payloadData.TransformInfo(0, 0, 0, 0);
        ...
        // const statInfo = payloadData.StatInfo(1, 1, 1, 1, 1, 1, 1, 1, 1);
        ...
        //const enter = payload.S2CEnter(playerInfo);
        //const packet2 = makePacket(config.packetId.S2CEnter, enter);
        //getPlayerSession().notify(2, packet2);
      }
