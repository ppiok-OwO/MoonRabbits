export const SQL_QUERIES = {
  ...
  SAVE_HOUSING_DATA:
    'INSERT INTO SaveHousing (house_id, player_id, item_id, data_type, posX, posY, posZ, rot) VALUES (?, ?, ?, ?, ?, ?, ?, ?)',
  LOAD_HOUSING_DATA:
    'SELECT item_id, data_type, posX, posY, posZ, rot FROM SaveHousing WHERE player_id = ?',
